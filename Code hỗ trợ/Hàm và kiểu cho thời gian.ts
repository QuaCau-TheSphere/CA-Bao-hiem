import { ThiếtLậpPhí } from "../Code chính/Vật thể phí.ts";
...
export function làTemporal(x: any): x is Temporal.PlainDate {
  if ((x as Temporal.PlainDate).day) return true;
  return false;
}
